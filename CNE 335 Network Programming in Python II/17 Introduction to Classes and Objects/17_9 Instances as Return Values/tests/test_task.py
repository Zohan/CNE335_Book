...
class TestCase(unittest.TestCase):
    ...
    def test_biggest_ip_sum_zero_and_one(self):
        ...
        self.assertEqual(biggest_server_object_sum(ip_zero, ip_one), ip_one)

    def test_biggest_ip_sum_localhost_and_dhcp(self):
        ip_localhost = ServerClass("127.0.0.1")
        ip_dhcp = ServerClass("192.168.0.1")
        self.assertEqual(biggest_server_object_sum(ip_localhost, ip_dhcp), ip_dhcp)
    ...
    def test_random_ip(self):
        ...
        self.assertEqual(biggest_server_object_sum(ip_base, ip_bigger), ip_bigger)